...
if __name__=="__main__":
    ...
    b4=Button(root,text="Submit",command=pos,activebackground="#FFFFFF",bg="#19c37d",width=30)
    b4.place(x=363,y=200)
    b3=Button(root,text="Close",command=clse,bg="#19c37d",activebackground="red",width=30)
