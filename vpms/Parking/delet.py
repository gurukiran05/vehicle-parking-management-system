...
if __name__=="__main__":
    ...
    b4=Button(root,text="Checkout",command=delete_vehicle,activebackground="red",bg="#19c37d",width=30)
    b4.place(x=363,y=300)
    b3=Button(root,text="Back",command=clse,bg="#19c37d",activebackground="red",width=30)
